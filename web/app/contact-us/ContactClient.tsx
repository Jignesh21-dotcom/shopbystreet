...
Why I'd like to become an ambassador:
...
Thank you!`
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error: insertError } = await supabase.from('contact_requests').insert([
      {
        ...
        message: cleanedFormData.message,
        file_url: cleanedFormData.fileUrl,
      },
    ]);
    ...
    setSubmittedEmail(cleanedFormData.email);
    setSuccess(true);
    setFormData({
      name: '',
      email: '',
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            {success ? (
              <div className="text-center">
                ...
                <h2 className="mb-3 text-3xl font-extrabold text-slate-950">
                  Thanks for contacting us
                </h2>

                <p className="text-slate-600">
                  We received your message and sent a confirmation email to:
                </p>
