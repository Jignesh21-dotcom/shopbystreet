  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-sm text-gray-700 leading-relaxed">
      ...
      <ul className="list-disc ml-5 space-y-1">
        ...
        <li>Files you upload, such as spreadsheets or product photos.</li>
        <li>Messages submitted through our Contact Us form.</li>
        <li>Street Ambassador application information, including city, school (if provided), availability, and other information you voluntarily submit.</li>
      ...
      <ul className="list-disc ml-5 space-y-1">
        ...
        <li>Help businesses upload products when requested.</li>
        <li>Review and manage Street Ambassador applications.</li>
