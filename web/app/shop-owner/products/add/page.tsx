...
export default function AddProduct() {
  ...
  return (
    <>
      <SEO
        title="Add New Product | Shop Owner Panel"
        description="Shop owners can add new products with descriptions, images, and pricing."
        url="https://www.localstreetshop.com/shop-owner/products/add"
      />
