...
function MarketplaceOrderRequestBanner({ countrySlug }: { countrySlug: string }) {
  const marketplaceFee = countrySlug === 'india' ? 39 : 2;
  const formattedMarketplaceFee = formatCurrency(marketplaceFee, countrySlug);
  ...
  request adds a {formattedMarketplaceFee} Marketplace Fee to your pending balance. Declined,
  ...
  are free. After that, each accepted request adds a {formattedMarketplaceFee} Marketplace Fee.
...
export default function ShopOwnerDashboardClient() {
                      ...
                      <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="rounded-xl bg-amber-50 p-4">
                          ...
                          <p className="mt-1 text-2xl font-extrabold text-amber-950">
                            {formatCurrency(shop.pending_fee_total, shop.countrySlug)}
                          </p>
                        ...
                        <div className="rounded-xl bg-slate-100 p-4">
                          ...
                          <p className="mt-1 text-xs text-slate-600">
                            {shop.pending_fee_total > 0
                              ...
                              : `${formatCurrency(shop.countrySlug === 'india' ? 39 : 2, shop.countrySlug)} per accepted request after your first 5 free`}
                          </p>
                        </div>
                      </div>
  ...
  <strong> {formatCurrency(shop.countrySlug === 'india' ? 39 : 2, shop.countrySlug)} Marketplace Fee</strong>. Declined, cancelled, and expired
