    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-white px-4 py-12 text-gray-900">
      <div className="mx-auto max-w-6xl">
        <section className="mb-10 text-center">
          ...
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight text-gray-950 md:text-5xl">
        ...
        <section className="mb-8 rounded-3xl border border-blue-100 bg-white p-6 shadow-sm md:p-10">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              ...
              prefetch={false}
              className="rounded-full bg-blue-700 px-6 py-3 text-center font-semibold text-white shadow-sm transition hover:bg-blue-800"
            >
            ...
            <Link
              href="/login"
              className="rounded-full border border-blue-200 bg-white px-6 py-3 text-center font-semibold text-blue-700 shadow-sm transition hover:bg-blue-50"
            >
              Login
            </Link>
          ...
          <div className="mx-auto mt-8 max-w-3xl rounded-2xl border border-yellow-200 bg-yellow-50 p-5 text-center shadow-sm">
        ...
        <section className="rounded-3xl bg-blue-700 p-6 text-white shadow-sm md:p-8">
