...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.localstreetshop.com/countries/india/${resolvedParams.state}/${resolvedParams.city}/streets/${resolvedParams.street}/${resolvedParams.shop}/products/${resolvedParams.product}/request`,
    },
  };
}
...
export default async function RequestOrderPage({ params }: PageProps) {
  ...
  const productsHref = `/countries/india/${stateSlug}/${citySlug}/streets/${streetSlug}/${shopSlug}/products`;
  const shopHref = `/countries/india/${stateSlug}/${citySlug}/streets/${streetSlug}/${shopSlug}`;
