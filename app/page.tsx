...
export default function HomePage() {
  const title = 'Shop Street | Discover Local Businesses Across Canada';
  const description = 'Explore authentic local shops across Canadian cities and streets. Support small businesses and shop local with ShopByStreet.';
